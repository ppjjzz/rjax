...
import { jsonpCallbackContext } from './handler';
...
export class JsonpClientBackend implements HttpBackend {
  ...
  private callbackMap: JsonpCallbackContext = <JsonpCallbackContext>jsonpCallbackContext(); 
  constructor() {}
...
export class JsonpInterceptor {
  private jsonp: JsonpClientBackend = new JsonpClientBackend();
  constructor() {}
